...
const freeTierFeatures = ['Comedy Dashboard', 'Laugh Timeline', 'Basic Feedback'];
const starterTierFeatures = ['Everything in Free', 'Gap Analysis', 'Punch-Up Suggestions', 'Analysis History'];
const proTierFeatures = ['Everything in Starter', 'Character Analysis', 'Callback Mapping', 'PDF Export', 'Priority Support'];
